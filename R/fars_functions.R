...
fars_read_years <- function(years) {
  MONTH = NULL # Avoid no visible binding for global variable note
...
fars_summarize_years <- function(years) {
  year = MONTH = n = NULL # Avoid no visible binding for global variable note
...
fars_map_state <- function(state.num, year) {
  STATE = NULL # Avoid no visible binding for global variable note
